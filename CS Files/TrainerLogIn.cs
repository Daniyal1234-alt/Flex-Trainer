...
namespace DB_Milestone_2
{
    public partial class TrainerLogIn : Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "USE PROJECT_DB Select 1 from PROJECT_DB.dbo.Trainer where Name = '" + username + "' and pass = '" + password + "'";
                ...
                if (command1.ExecuteScalar() != null)
                {
                    ...
                    if (found == "1")
                    {
                        ...
                        timer.Tick += (s, args) =>
                        {
                            ...
                            timer.Dispose();
                            this.Hide();
                            string query2 = "USE PROJECT_DB Select TrainerID from PROJECT_DB.dbo.Trainer where Name = '" + username + "' and pass = '" + password + "'";
                            ...
                            int regBit = (int)command.ExecuteScalar();
